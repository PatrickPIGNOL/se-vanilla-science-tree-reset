...
if settings.startup["SE-vanilla-science-tree-reset-activated"].value then
  log("SE-vanilla-science-tree-reset-activated")
  log("Recipes loop...")
  for vIndex, vRecipe in ipairs(vRecipes) 
  do
    log("Recipe : '"..vRecipe.name.."'...");
    mSetRecipe(vRecipe);
    log("Recipe : '"..vRecipe.name.."' Done !");
  end
  log("Recipes loop Done !")
else
